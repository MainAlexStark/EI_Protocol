...
class Word():
    ...
    def create_template(self, path: str, values: dict, file_name: str, standarts: list):
        ...
        try:
            ...
            for paragraph in doc.paragraphs:
                ...
                for key, value in values.items():
                    if value in paragraph.text:
                        paragraph.text = paragraph.text.replace(value[1:-1], key)
                ...
                paragraph.text = paragraph.text.replace(standarts[0], "ЭТАЛОНЫ").replace(';','')
            ...
            QMessageBox.warning(self, 'Ошибка создания шаблон', e)