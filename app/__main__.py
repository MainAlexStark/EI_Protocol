...
from dialogs.ChooseScaleDialog import ChooseScaleDialog
from dialogs.SettingDialog import SettingDialog
from dialogs.ChooseInspectionAddressDialog import ChooseInspectionAddressDialog
from dialogs.CreateProtocolDialog import CreateProtocolDialog
...
class App(QWidget):
    ...
    def create_protocol(self):
        ...
        # Создаем протокол
        result = functions.make_new_protocol(args)
